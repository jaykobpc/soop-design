...
new KtWidget({
  selectorOpen: "#card-listopen-1",
  selectorWidget: "#card-listview-1",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-2",
  selectorWidget: "#card-listview-2",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-3",
  selectorWidget: "#card-listview-3",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-4",
  selectorWidget: "#card-listview-4",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-5",
  selectorWidget: "#card-listview-5",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-6",
  selectorWidget: "#card-listview-6",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-7",
  selectorWidget: "#card-listview-7",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-8",
  selectorWidget: "#card-listview-8",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-9",
  selectorWidget: "#card-listview-9",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-10",
  selectorWidget: "#card-listview-10",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-11",
  selectorWidget: "#card-listview-11",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-12",
  selectorWidget: "#card-listview-12",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-13",
  selectorWidget: "#card-listview-13",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-14",
  selectorWidget: "#card-listview-14",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-15",
  selectorWidget: "#card-listview-15",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#card-listopen-16",
  selectorWidget: "#card-listview-16",
  classSelector: "show_listview",
});
new KtWidget({
  selectorOpen: "#navbar_open",
  selectorWidget: "#navbar_drop",
  classSelector: "show_dropdown",
});
new KtWidget({
  selectorOpen: "#navbar_open",
  selectorWidget: "#navbar_drop",
...
new KtWidget({
  selectorOpen: "#sidenav_explore",
  selectorWidget: "#sidenav_explore_open",
  classSelector: "show_side",
});
new KtWidget({
  selectorOpen: "#exit-btn",
  selectorWidget: "#exit-modal",
  classSelector: "show_exit_modal",
});
...
(function () {
  ...
  window.addEventListener("load", function () {
    ...
    var appLoaderWindow = document.querySelector("#apploader");

    /**show loading screen */
    //appLoaderWindow.classList.add("loader-fade");

    /** Interval */
    var Loader = setInterval(isLoading, 80);
